          ...
          new Listr(
            [
              ...
              },
              {
                title: `Checkout branch ${config.develop}`,
                task: (ctx, task) =>
                  git.checkout(config.develop).pipe(
                    catchError(() => {
              ...
              },
              {
                ...
                task: (ctx, task) =>
                  git.branch("-D", config.production).pipe(
                    catchError(() => {
              ...
              },
              {
                ...
                task: () =>
                  git.checkout("-b", config.production, config.remoteProduction)
              },
              {
                title: `Checkout branch ${config.develop}`,
                task: (ctx, task) =>
              ...
              },
              {
                ...
                task: () =>
                  git.reset("--hard", `refs/heads/${config.production}`)
              },
