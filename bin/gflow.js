...
commander
  ...
  .command(
    "finish",
    "Merge the current branch on the referenced branch (production or ancestor) and delete it"
  )
  .command(
    "merge",
    "Merge the current branch on the referenced branch (production or ancestor) without deleting branch"
  )
  .command(
    "release",
  ...
  .command(
    "new",
    "Create a new branch from the latest commit of production branch"
  )
  .command(
    "push",
    "Rebase the current branch from production and push all commit (run test before)"
  )
  .command("rebase", "Rebase the current branch from production")
  .command("rebase-all", "Rebase all branches from production")
  .command(
    "fetch",
    "Download objects and refs from another repository (--all and --prune)"
  )
